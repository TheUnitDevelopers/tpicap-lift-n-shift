'undefined' === typeof jwplayer && (jwplayer = function () {
    ...
    w = m.each = m.forEach = function (e, b, h) {
        ...
        if (a && e.forEach === a) e.forEach(b, h);
         else if (e.length === + e.length) for (var c = 0, p = e.length; c < p; c++) {
    ...
    m.find = m.detect = function (a, e, b) {
        var h;
        u(a, function (a, c, p) {
            if (e.call(b, a, c, p)) return h = a,
            !0
        });
        return h
    };
    ...
    m.indexOf = function (a, e, b) {
        ...
        var c = 0,
        p = a.length;
        if (b) if ('number' == typeof b) c = 0 > b ? Math.max(0, p + b)  : b;
         else return c = m.sortedIndex(a, e),
        a[c] === e ? c : - 1;
    ...
    m.defer = function (a) {
        return m.delay.apply(m, [
            a,
            1
        ].concat(b.call(arguments, 1)))
    };
    m.keys = function (a) {
    ...
    function l(a, e, c, d, h) {
        return function () {
            ...
            if (h) c(a);
                ...
                if (p && g) return c(a);
                (p = b.parseXML(a.responseText)) && p.firstChild ? (a = b.extend({
                }, a, {
                    responseXML: p
    ...
    b.getCookies = function () {
        for (var a = {
        }, e = document.cookie.split('; '), b = 0; b < e.length; b++) {
            var c = e[b].split('=');
    ...
    b.translateEventResponse = function (a, e) {
        ...
        'duration',
        'offset'], function (a, e) {
            c[e] && (c[e] = Math.round(1000 * c[e]) / 1000)
        });
        return c
    };
    ...
    b.repo = function () {
        var a = 'https://p.jwpcdn.com/' + f.version.split(/\W/).splice(0, 2).join('/') + '/';
        try {
    ...
    b.ajax = function (a, c, d, g) {
        ...
        b.exists(window.XDomainRequest)) h = new window.XDomainRequest,
        h.onload = l(h, a, c, d, g),
    ...
    b.parseXML = function (a) {
        ...
        try {
            ...
            } else c = new window.ActiveXObject('Microsoft.XMLDOM'),
            c.async = 'false',
            c.loadXML(a)
        } catch (b) {
            return
...
function (f) {
    ...
    var q = c.css = function (c, b, f) {
        ...
        q,
        n;
        for (q in b) n = l(q, b[q], f),
        '' !== n ? n !== r[q] && (r[q] = n, u = !0)  : void 0 !== r[q] && (delete r[q], u = !0);
        if (u) {
            if (!g[c]) {
                b =
    ...
    q.unblock = function (a) {
        if (e && (!a || e.id === a)) {
            ...
            for (a = 0; a < e.elements.length; a++) c = e.elements[a],
            b(c, c.__cssRules);
            e = null
        }
    };
        ...
        this.load = function () {
            if (k === d.NEW) {
                ...
                g.onload = g.onreadystatechange = function (a) {
                    if (!q && (!this.readyState || 'loaded' === this.readyState || 'complete' === this.readyState)) q = !0,
                    j(a),
...
function (f) {
    f.key = function (d) {
        ...
        try {
            ...
            var c = d.split('/');
            (l = c[0]) ? /^(free|pro|premium|enterprise|ads)$/i.test(l) ? (b = c[1], c[2] && 0 < parseInt(c[2]) && (j = new Date, j.setTime(String(c[2]))))  : l = 'invalid' : l = 'free'
        } catch (g) {
            l = 'invalid'
        }
    }
...
function (f) {
    ...
    d.encrypt = function (j, c) {
        ...
        for (var k = d.strToLongs(b.encode(c).slice(0, 16)), a = g.length, e = g[a - 1], f = g[0], q, h = Math.floor(6 + 52 / a), p = 0; 0 < h--; ) {
            p += 2654435769;
            q = p >>> 2 & 3;
            for (var m = 0; m < a; m++) f = g[(m + 1) % a],
            e = (e >>> 5 ^ f << 2) + (f >>> 3 ^ e << 4) ^ (p ^ f) + (k[m & 3 ^ q] ^ e),
            e = g[m] += e
        }
        g = d.longsToStr(g);
        return l.encode(g)
    ...
    d.decrypt = function (j, c) {
        ...
        for (var g = d.strToLongs(l.decode(j)), k = d.strToLongs(b.encode(c).slice(0, 16)), a = g.length, e = g[a - 1], f = g[0], q, h = 2654435769 * Math.floor(6 + 52 / a); 0 != h; ) {
            q = h >>> 2 & 3;
            for (var p = a - 1; 0 <= p; p--) e = g[0 < p ? p - 1 : a - 1],
            e = (e >>> 5 ^ f << 2) + (f >>> 3 ^ e << 4) ^ (h ^ f) + (k[p & 3 ^ q] ^ e),
            f = g[p] -= e;
            h -= 2654435769
        }
        g = d.longsToStr(g);
    ...
    var l = {
        ...
        encode: function (d, c) {
            ...
            a = e >> 6 & 63,
            e &= 63,
            f[h / 3] = m.charAt(g) + m.charAt(k) + m.charAt(a) + m.charAt(e);
            f = f.join('');
        ...
        decode: function (d, c) {
            ...
            p = l.code;
            h = c ? b.decode(d)  : d;
            for (var m = 0; m < h.length; m += 4) g = p.indexOf(h.charAt(m)),
            k = p.indexOf(h.charAt(m + 1)),
            e = p.indexOf(h.charAt(m + 2)),
            f = p.indexOf(h.charAt(m + 3)),
            a = g << 18 | k << 12 | e << 6 | f,
            g = a >>> 16 & 255,
            k = a >>> 8 & 255,
            a &= 255,
            q[m / 4] = String.fromCharCode(g, k, a),
            64 == f && (q[m / 4] = String.fromCharCode(g, k)),
            64 == e && (q[m / 4] = String.fromCharCode(g));
            e = q.join('');
    ...
    b = {
        ...
        decode: function (b) {
            b = b.replace(/[\u00e0-\u00ef][\u0080-\u00bf][\u0080-\u00bf]/g, function (c) {
                c = (c.charCodeAt(0) & 15) << 12 | (c.charCodeAt(1) & 63) << 6 | c.charCodeAt(2) & 63;
    ...
    f.events.eventdispatcher = function (l, b) {
        ...
        this.addEventListener = function (b, a, e) {
            try {
                ...
                'string' === d.typeOf(a) && (a = (new Function('return ' + a)) ()),
                c[b].push({
                    listener: a,
                    count: e || null
                })
        ...
        this.addGlobalListener = function (b, a) {
            try {
                'string' === d.typeOf(b) && (b = (new Function('return ' + b)) ()),
                g.push({
                    listener: b,
                    count: a || null
                })
...
function (f) {
    ...
    f.plugin = function (b) {
        ...
        d.extend(this, h);
        this.load = function () {
            if (k === d.loaderstatus.NEW) if (0 < b.lastIndexOf('.swf')) a = b,
            k = d.loaderstatus.COMPLETE,
            h.sendEvent(l.COMPLETE);
        ...
        this.getFlashPath = function () {
            if (a) switch (d.getPluginPathType(a)) {
                case d.pluginPathType.ABSOLUTE:
                    return a;
                case d.pluginPathType.RELATIVE:
                    return 0 < b.lastIndexOf('.swf') ? d.getAbsolutePath(a, window.location.href)  : d.getAbsolutePath(a, j())
            }
            return null
        };
        this.getJS = function () {
...
function (f) {
    ...
    b = f._,
    j = d.foreach;
    f.plugins.pluginloader = function (c, g) {
        function f() {
        ...
        function e(b) {
            ...
            }), b.url && d.log('File not found', b.url), a())
        }
        ...
        this.setupPlugins = function (a, b, e) {
            ...
            j(b.plugins, function (c, j) {
                ...
                m = l.getJS(),
                u = l.getURL();
                r && (g.plugins[r] = d.extend({
                }, j), g.plugins[r].pluginmode = l.getPluginmode(), g.length++);
                try {
                    if (m && b.plugins && b.plugins[u]) {
                        ...
                        0;
                        q.style.zIndex = f + 10;
                        h[p] = l.getNewInstance(a, d.extend({
                        }, b.plugins[u]), q);
                        f++;
                        a.onReady(e(h[p], q, !0));
                        a.onResize(e(h[p], q))
        ...
        this.destroy = function () {
            w = !0;
            u && (u.resetEventListeners(), u = null)
        };
        this.pluginFailed = e;
        this.getStatus = function () {
            return r
...
function (f) {
    ...
    (d.jwparser = function () {
        ...
        ], g = f.utils.xmlAttribute, k = 0; k < l.childNodes.length; k++) {
...
function (f) {
    var d = f.item = function (l) {
        ...
        0 === j.sources.length && (j.sources = [
            new f.source(j)
        ]);
        for (c = 0; c < j.sources.length; c++) g = j.sources[c]['default'],
        j.sources[c]['default'] = g ? 'true' === g.toString()  : !1,
        j.sources[c] = new f.source(j.sources[c]);
                ...
                v.load(p.playlist);
                    ...
                    for (e = 0; e < p.modes.length; e++) {
                        ...
                        if (h && c[h]) {
                            ...
                            B = new c[h](F, d, m, n, g);
                            if (B.supportsConfig()) return B.addEventListener(b.ERROR, a),
                            B.embed(),
                            l.css('object.jwswf, .jwplayer:focus', {
                                outline: 'none'
                            }),
...
function (f) {
    function d(c) {
        if (c.playlist) for (var d = 0; d < c.playlist.length; d++) c.playlist[d] = new j(c.playlist[d]);
         else {
            var f = {
            };
            ...
            f.sources || (c.levels ? (f.sources = c.levels, delete c.levels)  : (d = {
            }, l(c, d, 'file'), l(c, d, 'type'), f.sources = d.file ? [
                d
            ] : [
            ]));
            c.playlist = [
    ...
    (f.embed.config = function (c) {
        ...
        k = {
            ...
            src: '/~/media/Files/I/Icap-Careers/videos/jwplayerflash.swf'
        };
        c.modes = 'flash' === c.primary ? [
            k,
            g
        ] : [
            g,
...
function (f) {
    ...
    f.embed.download = function (b, f, c) {
        ...
        if (p && p.length) {
            m = p[0];
            w = m.sources;
            for (p = 0; p < w.length; p++) u = w[p],
            u.file && (t = u.type || l.extensionmap.extType(l.extension(u.file)), 0 <= l.indexOf(k, t) ? (a = u.file, q = m.image)  : l.isYouTube(u.file, t) && (h = u.file));
            a ? (c = a, b && (a = g('a', 'display', b), g('div', 'icon', a), g('div', 'logo', a), c && a.setAttribute('href', l.getAbsolutePath(c))), c = '#' + b.id + ' .jwdownload', b.style.width = '', b.style.height = '', d(c + 'display', {
                width: l.styleDimension(Math.max(320, e)),
            ...
            h ? (f = h, b = g('iframe', '', b), b.src = 'https://www.youtube.com/embed/' + l.youTubeID(f), b.width = e, b.height = r, b.style.border = 'none')  : c()
        }
    }
}(jwplayer),
function (f) {
    ...
    (f.embed.flash = function (c, g, k, a, e) {
        ...
        this.embed = function () {
            ...
            v.base = j + '/';
            b[t] = v;
            d.isMSIE() ? (c.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="' + t + '" name="' + t + '" tabindex="0"><param name="movie" value="' +
...
function (f) {
    ...
    f.embed.html5 = function (c, g, k, a, e) {
        ...
        this.destroy = function () {
            j && (j.resetEventListeners(), j = null)
        }
    };
...
function (f) {
    ...
    f.embed = b.extend(function (g) {
        ...
        switch (n) {
            ...
            case 'premium':
                j.related && (c.test(j.related.client) && (u = j.related.client), h[u] = j.related),
                j.ga && (c.test(j.ga.client) && (t = j.ga.client), h[t] = j.ga);
            case 'pro':
                j.sharing && (c.test(j.sharing.client) && (w = j.sharing.client), h[w] = j.sharing),
                j.skin && (l.skin = j.skin.replace(/^(beelden|bekle|five|glow|modieus|roundster|stormtrooper|vapor)$/i, b.repo() + 'skins/$1.xml'))
        }
        l.plugins = h;
        g.config = l;
        g = new d(g);
...
function (f) {
    ...
    f.cast.setupCastConfig = function (b, g) {
        ...
        for (var a = 'base autostart controls fallback fullscreen width height mobilecontrols modes playlistlayout playlistposition playlistsize primary stretching sharing related ga skin logo listbar events'.split(' '), e = a.length; e--; ) delete k[a[e]];
        a = k.plugins;
        delete k.plugins;
    ...
    b.controller = function (a, e) {
        ...
        function w(f, g) {
            ...
            if (h.reconcile) {
                ...
                var j = h.diff,
                k = H;
                if (!j.id || !h.appid || !h.pageUrl) j.id = d().id,
                h.appid = G.appid,
                h.pageUrl = T,
                H = A = null;
        ...
        function B(k) {
            ...
            O = k;
                ...
                a.jwSkipAd = function (a) {
                    C && (C.skipAd(a), a = C.getAdModel(), a.complete = !0, e.sendEvent(c.JWPLAYER_CAST_AD_CHANGED, a))
                };
        ...
        function P(d) {
            if ('state' ===
            d.type) {
                if (C && (d.diff.newstate || d.diff.position)) C.destroy(),
                C = null,
                e.setVideoProvider(D),
        ...
        l(G, 'endscreen');
        l(G, 'logo');
        if (G.appid && (!f.cast || !f.cast.receiver)) b.loader.addEventListener('availability', p),
        b.loader.addEventListener('session', m),
        b.loader.initialize(G.appid);
...
function (f) {
    ...
    function l(a, b) {
        ...
        if (!c) throw 'Message not proper JSON';
        if (c.reconcile) {
            x.removeMessageListener(h.NS, l);
            c.receiverFriendlyName = x.receiver.friendlyName;
            if (!c.pageUrl || !c.diff.id || !c.appid) c.pageUrl = B,
            c.diff.id = f().id,
            c.appid = v,
            x = y = null;
    ...
    x,
    z,
    B = p.getAbsolutePath(window.location.href),
    y;
...
function (f, d) {
    ...
    function b() {
        d && d.cast && d.cast.isAvailable && !e.apiConfig ? (e.apiConfig = new d.cast.ApiConfig(new d.cast.SessionRequest(m), k, a, d.cast.AutoJoinPolicy.ORIGIN_SCOPED), d.cast.initialize(e.apiConfig, g, c))  : 15 > p++ && setTimeout(b, 1000)
    }
    function j() {
    ...
    w = r.extend({
        initialize: function (a) {
            ...
            })  : d && d.cast ? b()  : h || (h = new r.scriptloader('https://www.gstatic.com/cv/js/sender/v1/cast_sender.js'), h.addEventListener(q.ERROR, j), h.addEventListener(q.COMPLETE, b), h.load())
        }
...
function (f, d) {
    ...
    f.api = function (h) {
        ...
        n.addButton = function (a, c, d, e) {
            try {
                J[e] = d,
                t('jwDockAddButton', a, c, 'jwplayer("' + n.id + '").callback("' +
                e + '")', e)
            } catch (f) {
        ...
        n.getPlaylist = function () {
            ...
            'flash' === n.renderingMode && b.deepReplaceKeyName(a, [
                '__dot__',
                '__spc__',
                '__dsh__',
                '__default__'
        ...
        n.resize = function (a, c) {
            if ('flash' !== n.renderingMode) t('jwResize', a, c);
             else {
        ...
        g(q, function (a, b) {
            x[a] || (x[a] = [
            ], u(j.JWPLAYER_PLAYER_STATE, function (b) {
                var c = b.newstate;
                b = b.oldstate;
                if (c === a) {
                    var d = x[c];
        ...
        n.playerReady = function (a) {
            ...
            u(j.JWPLAYER_PLAYLIST_ITEM, function () {
                F = {
                }
            });
...
function (f) {
    ...
    f.api.instream = function (f, c) {
        function g(a, b) {
            r[a] || (r[a] = [
            ], c.jwInstreamAddEventListener(a, 'function(dat) { jwplayer("' + f.id + '").dispatchInstreamEvent("' + a + '", dat); }'));
            r[a].push(b);
            return this
        }
        function k(a, b) {
            q[a] || (q[a] = [
            ], g(d.JWPLAYER_PLAYER_STATE, function (b) {
                var c = b.newstate,
                d = b.oldstate;
                if (c === a) {
                    var e = q[c];
